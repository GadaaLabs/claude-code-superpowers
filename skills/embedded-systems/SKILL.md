...
**Announce at start:** "I'm using the embedded-systems skill for EE-specific patterns."
...
- Any + 7 → Stack Size Estimation + run `systematic-debugging`
...
| Skill | Integration |
|-------|-------------|
| `test-driven-development` | Write hardware-in-loop tests first |
| `systematic-debugging` | Debug timing violations, race conditions |
| `verification-before-completion` | Verify timing budgets before claiming success |
| `learning-from-experience` | Store hardware-specific patterns |
