...
| 3 Yes | MEDIUM | Invoke `requesting-code-review` before marking complete |
| ≤ 2 Yes | LOW | Invoke `systematic-debugging` — root cause not fully understood |
| Security/arch task | ANY | ALWAYS invoke `requesting-code-review` |
