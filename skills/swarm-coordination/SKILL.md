...
| Skill | Integration |
|-------|-------------|
| `subagent-driven-development` | Use Hierarchical topology by default |
| `brainstorming` | Use Mesh topology for exploration phase |
| `systematic-debugging` | Use Mesh topology for multi-angle investigation |
| `writing-plans` | Plan should specify recommended topology |
| `requesting-code-review` | Use Star topology for parallel file review |
